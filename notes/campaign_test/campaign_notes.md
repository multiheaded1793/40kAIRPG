# Campaign Test: DM Notes

## 0. System
Dark Heresy

## 1. The Premise
At the grim heart of Hive Rokarth—a towering edifice of misery, industry, and acid rain—a routine investigation ordered by Inquisitor Halikarn is about to go wrong. An acid refinery has exploded, and a single survivor walked out of the inferno untouched. The Adeptus Ministorum cries "miracle"; the Inquisition suspects something far worse. A warband of fresh acolytes is dispatched to discover the truth, but the trail quickly spirals into a web of heretek augmetics, gang warfare, and a Tzeentchian cult hiding in plain sight beneath a cathedrum. This is a starter scenario drawn from *The Blazing Seraph* adventure, designed as an introductory campaign for the AI DM engine.

## 2. The Setting: Hive Rokarth, Voll
*   **Atmosphere:** Oppressive industrial noir. Acid-etched rockrete, the perpetual shriek of heavy machinery, and flickering lumen-globes that barely hold back the dark. The air burns the throat and the crowds press like cattle. Everything reeks of promethium and desperation.
*   **Key Elements:**
    *   **Thaler Hostelry:** The party's base — a colossal hab-zone of 20,000 souls. Their quarters are a repurposed Munitorum container with rag-filled bunks and a half-melted shrine.
    *   **Acid Refinery Delta-64 (Ruins):** The epicentre of the "miracle". A 100-metre blast radius of slag surrounds a perfectly preserved two-metre sphere — the footprint of a refractor field. A faint blue glow (residual radiation) attracts pilgrims and preachers.
    *   **Augmetics Manufactorum Phi-99:** An Adeptus Mechanicus facility overlooking the ruins, bristling with pict-recorder servitors. A source of evidence and a political minefield.
    *   **Precinct Fortress Majoris:** An entire hive level dedicated to the Macharian Vigilites. A glacial bureaucracy of coffin-cells and processing queues.
    *   **The Datamill District:** A sprawling Administratum labyrinth of pneumatic tubes, incense-choked sanctums, and frantic scribes.
    *   **The Claymore:** A crashed Imperial cruiser repurposed as a criminal bar, deep in the Lower Hive. Scarred Hands territory.
...
*   **Sister Helza Scorn (PC — Zealot / Adeptus Ministorum):** A fiery Sororitas missionary from the shrine world Macharia. Her faith burns hot, and her chainsword cuts through doubt and heretics alike. Her Ministorum credentials give her sway over the devout and can open doors (like the Vigilite Cordon). Carries a Hand Flamer for when diplomacy fails. Faithfulness grants her Willpower Bonus in SL on tests of faith once per session. Short-tempered; can enter Frenzy. Starts with 600 Solars.
...
*   **Macro-Structure (The Rails — Four-Part Investigation):**
    ...
    3.  **Pious Persecution:** The party presents their findings to Planetary Governor Castyx in a conclave also attended by Arch-Deacon Artosy. The political stakes rise. The Governor's verdict determines the resources available for the finale.
    4.  **Carnage at the Cathedrum:** The party assaults the Cathedrum of Rationed Beneficence, descends into the catacombs, confronts the Heretek workshop, and faces the inner sanctum of the Coven. The Blazing Seraph may begin to manifest.
*   **Micro-Structure (The Sandbox):** The player dictates *how* they tackle each lead—bribery, intimidation, stealth, or straight investigation. The order of the three leads in Part 2 is entirely player-driven. NPCs like Leo, Helza, and Reeta suggest but never dictate.
*   **Branching Elements:**
    *   Every use of the Inquisitorial Seal is tracked and may trigger a Cutter ambush or raise suspicion.
    *   If the party botches the Chop Shop encounter, Leo may lose more than his leg, or the party enters the investigation without a local guide.
