...
*   `notes/campaign_01/`: The DM's workspace.
    *   `dm_notes.md`: Analyzes the premise, tracking the setting, the party, the opposition, and the flexible sandbox structure. Ongoing thoughts and impressions are added over the course of the campaign.
    ...
    *   `mermaid/`: Holds topological Mermaid maps and Dataslate lore for the campaign.
        ...
        *   Locations (e.g., `hab_block_0F1C.md`): Used for persistent campaign locations, referenced directly in `dm_notes.md`.
...
*   **Context Management:** Treat `dm_notes.md` as a living document. Summarize past events and update goals frequently so the state of the campaign is always clear.
